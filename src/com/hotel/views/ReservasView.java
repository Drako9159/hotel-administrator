...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        lblCheckIn.setBounds(68, 136, 182, 14);
        lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
        panel.add(lblCheckIn);

        JLabel lblCheckOut = new JLabel("FECHA DE SALIDA");
        lblCheckOut.setForeground(SystemColor.textInactiveText);
        lblCheckOut.setBounds(68, 221, 182, 14);
        ...
        txtValor.setBounds(78, 328, 260, 33);
        txtValor.setEditable(false);
        txtValor.setFont(new Font("Roboto Black", Font.PLAIN, 17));
        //lblValor.setBounds(72, 303, 250, 14);
        ...
        btnguardar.setBounds(110, 493, 122, 35);
